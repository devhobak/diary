import { DayUI, DayLi, DaySection, DayOfLi, DayOfUI, DayDate } from "./style/calendar";
import { useRecoilState, useRecoilValue } from "recoil";
import { selectDateState } from "../../../recoil/atoms/calendarState";
import { ColorState } from "../../../recoil/atoms/recordState";
import { formatCurDataState, formatCurDay } from "../../../recoil/selectors/date";
         ...
         <DayUI title="">
            {formatDate.curMonthDay.map((item, idx) => {
               return formatDate.prevNextMonthday.includes(item) ? (
                  <DayLi key={idx} onClick={() => modalUp(item)} view={isMobile} color={recordColor[idx]}>
