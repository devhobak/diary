...
import { ModalBackground, ModalSection, CloseButton } from "../common/Modal/modal";
...
export default function Manual(props: { modal: boolean; setModal: React.Dispatch<React.SetStateAction<boolean>> }) {
   ...
   return (
      <ModalBackground view={isMobile} isClose={props.modal}>
         <ModalSection view={isMobile} isClose={props.modal} color="#fffff3">
            ...
            <CloseButton src={closeImg} alt="모달 닫는 버튼" onClick={modalClose} />
            ...
            <Slider {...settings}>
               ...
               <ManualDiv isMobile={isMobile}>
                  ...
                  <ManualImg src={manual2} alt="다이어리 메뉴얼 소개 색깔" />
               </ManualDiv>
               <ManualDiv isMobile={isMobile}>
                  <ManualP>
                     그래프로 한눈에 <br />알 수 있어요.
                  </ManualP>
                  <ManualSubP>소중한 순간을 차곡차곡 쌓아봐요.</ManualSubP>
                  <ManualImg src={manual3} alt="다이어리 메뉴얼 소개 통계" />
               </ManualDiv>
            </Slider>
         </ModalSection>
      </ModalBackground>
