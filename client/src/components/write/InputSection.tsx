   ...
   return (
      <WriteForm onSubmit={onSubmit} view={isMobile}>
         <div className="tooltip">
            <Color type="color" name="content_color" defaultValue="#FBD96D"></Color>
            <span className="tooltiptext">🐶 선택한 색상으로 기록됩니다.</span>
         </div>
         ...
         <WriteDiv view={isMobile}>
            <WriteTitle type="text" name="content_title" placeholder="제목을 입력해주세요"></WriteTitle>
            <WriteContents name="content_main" placeholder="일상을 기록해주세요"></WriteContents>
